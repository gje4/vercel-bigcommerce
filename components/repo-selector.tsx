          ...
          >
            ...
            <SelectContent className="bg-white">
              {repos && repos.length > 0 && (
                <div className="p-2 border-b bg-white">
                  <Input
                    ...
                    disabled={disabled}
                    className="text-base md:text-sm h-8 bg-white"
              ...
              {filteredRepos.length === 0 && repoFilter ? (
                <div className="p-2 text-sm text-muted-foreground text-center bg-white">
                  No repositories match &quot;{repoFilter}&quot;
                </div>
              ) : showReposLoading ? (
                <div className="p-4 flex items-center justify-center gap-2 text-sm text-muted-foreground bg-white">
                ...
                <>
                  {displayedRepos.map((repo) => (
                    <SelectItem key={repo.full_name} value={repo.name} className="bg-white">
                      <div className="flex items-center gap-2">
                  ...
                  {hasMoreRepos && (
                    <div className="p-2 text-xs text-muted-foreground text-center border-t bg-white">
