    ...
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="space-y-2 md:space-y-3 pb-3 md:pb-6 border-b pl-3 md:pl-6 pr-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 md:gap-4 md:flex-wrap text-xs md:text-sm overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          {task.v0ProjectUrl && (
            <div className="flex items-center gap-1.5 md:gap-2 flex-shrink-0">
              <ExternalLink className="w-3.5 h-3.5 md:w-4 md:h-4 flex-shrink-0 text-muted-foreground" />
              <a
                href={task.v0ProjectUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-foreground whitespace-nowrap flex items-center gap-1"
              >
                <span className="hidden sm:inline">View in v0</span>
